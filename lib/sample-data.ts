...
export const SAMPLE_LABELS: SampleLabel[] = [
  ...
  },
  {
    ...
    imageUrl: "/sample-labels/ironclad-brewing-ipa.png",
    description: "A beer label with no ABV stated at all — some beer is exempt from stating it.",
    applicationData: {
  ...
  },
  {
    ...
    imageUrl: "/sample-labels/meadowbrook-chardonnay.png",
    description: "A wine label (not distilled spirits) — clean pass, for beverage-type variety.",
    applicationData: {
      ...
      net_contents: "750 mL",
      producer_name_address: "Meadowbrook Cellars, Napa, CA",
      country_of_origin: "",
      is_import: false,
    },
  },
